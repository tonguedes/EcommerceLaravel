                    ...
                    <div class="shadow bg-white p-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" wire:model='fullname' name="fullname" class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" wire:model='phone' name="phone" class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" wire:model='pincode' name="pincode" class="form-control"
                                ...
                                <div class="d-md-flex align-items-start">
                                    <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                        ...
                                        <button class="nav-link active fw-bold"  id="cashOnDeliveryTab-tab"
                                            ...
                                            on Delivery</button>
                                        <button class="nav-link active show fw-bold" id="onlinePayment-tab" data-bs-toggle="pill"
