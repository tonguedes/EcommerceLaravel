                        ...
                        <div class="shadow bg-white p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" wire:model.defer='phone' name="phone" class="form-control"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" wire:model.defer='pincode' name="pincode" class="form-control"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab"
                                            ...
                                            <button   wire.loading.attr="disabled" wire.loading.attr="disabled" class="nav-link  fw-bold" id="cashOnDeliveryTab-tab"
