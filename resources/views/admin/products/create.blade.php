                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="small_description" class="form-controll" rows="4"></textarea>
                                </div>
                            ...
                            <div class="tab-pane fade" id="seotag-tag-pane" role="tabpanel" aria-labelledby="seotag-tag"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="meta_description" class="form-controll" rows="4"></textarea>
                                </div>
                                <div class="mb-3">
                                    <label>Meta Keyword</label>
                                    <textarea name="meta_keyword" class="form-controll" rows="4"></textarea>
                                </div>
